...
static const char *const autostart[] = {
    "dunst", NULL,
    // "picom", "-b", NULL,
    "flameshot", NULL, "copyq", NULL, "dwmblocks", NULL, NULL /* terminate */
};
...
static const Rule rules[] = {
    ...
    {NULL, NULL, "neovim", 1 << 1, 0, 0, 0, -1, 0},
    {"neovide", NULL, NULL, 1 << 1, 0, 0, 0, -1, 0},
...
static const char *emacscmd[] = {"emc", NULL};
