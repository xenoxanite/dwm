...
static const char *fonts[]          = { "JetbrainsMono Nerd Font:size=14:style=semibold" };
...
static const char *sptermcmd[] = {"t", "st", "-t", "spterm" , "-g", "120x25", NULL};
static const char *sptopcmd[]  = {"p", "st", "-t", "sptop", "-g", "120x25", "-e", "btop", NULL};
static const char *spmixcmd[]  = {"a", "st", "-t", "spmix", "-g", "120x25", "-e", "pulsemixer", NULL};
...
static const Key keys[] = {
	...
	{0,                             XK_F12,                   spawn,          {.v = volumecmd[0]} },
	{0,                             XK_F11,                   spawn,          {.v = volumecmd[1]} },
 	{0,                             XK_F10,                   spawn,          {.v = volumecmd[2]} },
	{0,                             XK_F8,                    spawn,          {.v = playerctlcmd[0]} },
 	{0,                             XK_F9,                    spawn,          {.v = playerctlcmd[1]} },
 	{0,                             XK_F7,                    spawn,          {.v = playerctlcmd[2]} },
