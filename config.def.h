...
static const char *colors[][3]      = {
	...
	[SchemeButtonBar]   = {selfgcolor,        normbgcolor,	      normbordercolor }, // also apply on systray
	...
	[SchemeInfoSel]     = {normfgcolor,       selbgcolor,         normbordercolor }, // infobar middle  selected {text,background,not used but cannot be empty}
